...
export default function Home() {
  ...
  const captureCatalog = async (): Promise<HTMLCanvasElement | null> => {
    ...
    // 1. Hide all no-export elements by setting display none directly
    const hiddenEls: { el: HTMLElement; orig: string }[] = [];
    const noExports = catalogRef.current.querySelectorAll('.no-export');
    ...
    // Extra delay to let images render
